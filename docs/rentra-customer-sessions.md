...
- **Completed parts:** 01–02 — COMPLETE (12 September 2026); 03–05 — COMPLETE (13 September 2026); 06–07 — COMPLETE (14 September 2026).
- **Next planned part:** 08 — search, filters and real location routes.
...
- **Next-session notes:** implement Part 08 search, filters and real location routes. Read [Part 07](rentra-customer-part07.md), [Part 06](rentra-customer-part06.md) and [the revised payment flow](rentra-payment-flow.md). Reuse shared saved hearts and valid selection URLs; account saved data must remain outside cached public pages and browser account storage. Preserve idempotent merge receipts and inactive rows used by unavailable-place undo. Keep active revocable identity, onboarding recovery, phone-change rotation and development-only 123456 intact. Search must match all selected dates and display truthful price bases using the Part 04 quote/inventory services. Preserve custom SQL in migrations 0008–0014. Customer checkout stays unavailable until Parts 11/12; do not enable payment or live collection as part of search work.
