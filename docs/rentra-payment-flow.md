...
**Part 14 status — 20 September 2026:** selected-visit cancellation, captured-allocation Test refund reservation, pinned provider execution, lookup-only recovery and durable worker/webhook reconciliation are implemented. Eight cancellation/browser, twelve ledger and five record database groups passed with deterministic fixtures. Migration 0016 is applied. No genuine provider refund was executed; credentials remain absent. See the [Part 14 runbook](rentra-customer-part14.md).
