  ...
  return (
    <details className="group relative">
      ...
      <div className="absolute left-0 right-auto z-20 mt-2 hidden w-52 group-open:block sm:left-auto sm:right-0 rounded-md border border-border bg-card p-2 shadow-lg">
        ...
        <a
          href={whatsappListingUrl({ text, url })}
          onClick={() => measureBrowser('share_attempted')}
          target="_blank"
          rel="noreferrer"
          className="flex min-h-11 items-center gap-2 rounded-sm px-3 text-meta font-semibold hover:bg-ink-50"
        >
