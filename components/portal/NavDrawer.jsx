...
export default function NavDrawer({ open, onClose, label, children }) {
  ...
  return (
    <dialog
      ...
      className="fixed inset-y-0 right-auto left-0 m-0 h-dvh max-h-dvh w-[min(86vw,320px)] max-w-none overflow-y-auto bg-brand-950 p-0 shadow-xl backdrop:bg-ink-900/55 backdrop:backdrop-blur-[2px] lg:hidden"
    >
      {open ? (
