...
export default async function AccountPage() {
  ...
  return <div className="space-y-8"><header><h1 className="text-h1">Your account</h1><p className="mt-3 text-body text-ink-600">Manage your profile and contact preferences.</p></header>
    ...
    <section className="rounded-lg bg-ink-50 p-4"><h2 className="font-semibold">Payment methods</h2><p className="mt-1 text-meta text-ink-600">There are no saved payment methods yet. Online booking will open in a later release.</p></section><CustomerLogout/>
  </div>;
}
