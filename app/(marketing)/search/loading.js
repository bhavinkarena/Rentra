export default function SearchLoading() {
  return (
    <section
      className="mx-auto min-h-screen max-w-(--container-page) px-4 py-10 sm:px-6"
      aria-busy="true"
    >
      ...
      <div aria-hidden="true" className="mt-20 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="aspect-4/3 rounded-lg bg-ink-100" />
        ))}
      </div>
    </section>
  );
