  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      ...
      <div className="mt-5 flex flex-wrap items-end justify-between gap-3">
        ...
        <span
          className={`rounded-full px-3 py-1 text-tiny font-bold ${
      ...
      <section className="mt-7 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <Panel title="Consent">
          <Row
            ...
            value={app.consentAt ? new Date(app.consentAt).toLocaleString('en-IN') : '—'}
        ...
        <ol className="mt-3 divide-y divide-border overflow-hidden rounded-lg border border-border bg-card">
          {trail.length === 0 ? (
            ...
            trail.map((t, i) => (
              <li
                key={i}
                className="flex flex-wrap items-baseline gap-x-3 gap-y-1 px-4 py-2.5 text-meta"
              >
