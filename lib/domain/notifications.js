export const notificationLabels = Object.freeze({
  ...
  reminder: 'Your visit is coming up',
  cancellation: 'Visits cancelled',
  refund: 'Refund update',
  completion: 'Visit completion recorded',
  review_invitation: 'How was your visit?',
});
export function notificationMessage(row) {
  const prefix =
    row.visit_provenance === 'real' && !row.is_test_payment ? 'Rentra' : 'Rentra Test / simulation';
