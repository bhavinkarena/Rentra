...
export const partnerApi = {
  ...
  overview: (id) => api.get(`/partner/listings/${id}/overview`, { cache: 'no-store' }),
  ...
  portfolioCalendar: (query) => api.get(`/partner/calendar${qs(query)}`, { cache: 'no-store' }),
  calendarIntervals: (id, query) =>
    api.get(`/partner/listings/${id}/calendar/state${qs(query)}`, { cache: 'no-store' }),
  ...
  reportIncident: (form) => api.post('/partner/records/incident', form),
  createCase: (form) => api.post('/partner/records/cases', form),
  caseUpdate: (form) => api.post('/partner/records/cases/update', form),
...
export const customerApi = {
  ...
  updatePhoto: (form) => api.post('/customer/account/photo', form),
...
export const adminApi = {
  properties: (query) => api.get(`/admin/properties${qs(query)}`, { cache: 'no-store' }),
  property: (id) => api.get(`/admin/properties/${id}`, { cache: 'no-store' }),
  assignProperty: (id, form) => api.post(`/admin/properties/${id}/assign`, form),
  decideProperty: (id, form) => api.post(`/admin/properties/${id}/decision`, form),
  scheduleVerification: (id, form) => api.post(`/admin/properties/${id}/verifications`, form),
  verificationCommand: (id, visitId, command, form) =>
    api.post(`/admin/properties/${id}/verifications/${visitId}/${command}`, form),
  publishProperty: (id, form) => api.post(`/admin/properties/${id}/publish`, form),
  propertyLifecycle: (id, command, form) => api.post(`/admin/properties/${id}/${command}`, form),
  applications: (query) => api.get(`/admin/applications${qs(query)}`, { cache: 'no-store' }),
  assignApplication: (id, form) => api.post(`/admin/applications/${id}/assign`, form),
  ...
  clients: (query) => api.get(`/admin/clients${qs(query)}`, { cache: 'no-store' }),
  client: (id) => api.get(`/admin/clients/${id}`, { cache: 'no-store' }),
  suspendClient: (id, form) => api.post(`/admin/clients/${id}/suspend`, form),
  reinstateClient: (id, form) => api.post(`/admin/clients/${id}/reinstate`, form),

  customers: (query) => api.get(`/admin/customers${qs(query)}`, { cache: 'no-store' }),
  customer: (id) => api.get(`/admin/customers/${id}`, { cache: 'no-store' }),
  restrictCustomer: (id, form) => api.post(`/admin/customers/${id}/restrict`, form),
  reinstateCustomer: (id, form) => api.post(`/admin/customers/${id}/reinstate`, form),
  revokeCustomerSessions: (id, form) => api.post(`/admin/customers/${id}/sessions/revoke`, form),
  correctCustomer: (id, form) => api.post(`/admin/customers/${id}/profile`, form),
  ...
  reportIncident: (form) => api.post('/admin/records/incident', form),
  cases: (query) => api.get(`/admin/records/cases${qs(query)}`, { cache: 'no-store' }),
  bookingCase: (id) => api.get(`/admin/records/cases/${id}`, { cache: 'no-store' }),
  createCase: (form) => api.post('/admin/records/cases', form),
  assignCase: (form) => api.post('/admin/records/cases/assign', form),
  caseUpdate: (form) => api.post('/admin/records/cases/update', form),
  previewCase: (form) => api.post('/admin/records/cases/preview', form),
  resolveCase: (form) => api.post('/admin/records/cases/resolve', form),
  closeIncident: (form) => api.post('/admin/records/incident/close', form),
  correctEvidence: (form) => api.post('/admin/records/evidence/correct', form),
