...
function attachMeta(data, payload) {
  ...
  // Redirect-only actions return data:null. Give their metadata a plain-object
  // carrier so runApiAction can navigate after the session cookies are relayed.
  // Ordinary null responses without metadata still return null above.
  if (data === null) data = {};
