...
export async function createAdminCase(_previous, formData) {
  return runApiAction(() => adminApi.createCase(formData));
}

export async function assignAdminCase(_previous, formData) {
  return runApiAction(() => adminApi.assignCase(formData));
}

export async function addAdminCaseUpdate(_previous, formData) {
  return runApiAction(() => adminApi.caseUpdate(formData));
}

export async function previewAdminCase(_previous, formData) {
  return runApiAction(() => adminApi.previewCase(formData));
}

export async function resolveAdminCase(_previous, formData) {
  return runApiAction(() => adminApi.resolveCase(formData));
}
